<div>
    ...
    <div class="max-w-[448px] mx-auto px-4 py-2">
        ...
        <div class="grid grid-cols-3 gap-4 justify-items-center">
            ...
            <a href="/products/<?php echo e($item->id); ?>" class="relative p-2 inline-block w-32 h-60 rounded-s">
                <!-- Ikon Plus -->
                <div class="absolute top-2 right-2">
                    <form wire:submit="send(<?php echo e($item->id); ?>)">
                ...
                <img src="storage/<?php echo e($item->image_url); ?>" alt="Produk" class="h-28 w-32 object-cover rounded-sm" loading="lazy">
                <div class="mt-3">
                    <!--[if BLOCK]><![endif]--><?php if($item->discounted_price > 0): ?>
                        <div class="flex items-center mt-2">
                            <span class="text-red-500 font-bold text-[12.5px]">Rp<?php echo e(number_format($item->discounted_price)); ?></span>
                            <span class="ml-2 text-gray-500 line-through text-[10.5px]">Rp<?php echo e(number_format($item->price)); ?></span>
                        </div>
                    <?php else: ?>
                        <p class="text-[12.5px] font-semibold text-gray-800">Rp<?php echo e(number_format($item->price)); ?></p>
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <span class="ml-1 text-xs text-gray-600">(<?php echo e($item->averageRating); ?>)</span>
                    </div>
                </div>
...
<?php /**PATH /media/rizkir/OS/Projects/E-Commerce/cimart/resources/views/livewire/search-page.blade.php ENDPATH**/ ?>